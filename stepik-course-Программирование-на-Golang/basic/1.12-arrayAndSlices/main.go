...
func main() {
	...
	/*numbers := [10]uint8{99, 151, 137, 71, 117, 187, 20, 93, 187, 67}
	res := WorkAndArray(numbers, []int{1, 2, 3, 5, 7, 8})
	if fmt.Sprintf("%T", res) == "[10]uint8" {
		fmt.Println(res, "type ok")
	}*/
	...
	//Sample Output:
	//49
	//fmt.Println(Element4ofSlice([]int{41, -231, 24, 49, 6}))
